...
- 分析
    - 回归的结果输入 sigmoid 函数中
    - 输出结果为 [0,1] 的概率值，一般默认 0.5 为阈值，小于是某个类比，大于是另一个
...
- sklearn.linear_model.LogisticRegression(solver='liblinear', penalty='l2', C=1.0)
    * solver: 优化**求解方式**（默认开源的 liblinear 库实现，内部使用了坐标轴下降法来迭代优化损失函数）
...
![](png/Pasted%20image%2020250909122956.png)  
!!! tip " 步骤 "  
